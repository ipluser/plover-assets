...
const logger = require('plover-logger')('plover-assets');
 ...
 * @param   {PloverApplication} proto  - Plover应用对象
 * @return  {Middleware}               - Koa中间件
 */
module.exports = function(settings, app, proto) {
  const moduleResolver = proto.moduleResolver;
  const filterOptions = {
    settings: settings,
